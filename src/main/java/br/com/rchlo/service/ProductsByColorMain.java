...
public class ProductsByColorMain {
    public static void main(String[] args) {
        ...
        List<Product> products = List.of(
                ProductsByColorMain.aJacket(),
                ProductsByColorMain.aJacket2(),
                ProductsByColorMain.aTShirt(),
                ProductsByColorMain.aTShirt2()
        );

        List<Product> res = pc.filter(Color.WHITE, products);

        for (Product pw: res) {
            System.out.println(pw.getCode() + ": " + pw.getColor());
        }
    ...
    public static Product aTShirt2() {
